...
import org.isaclarsen.backend.config.FirebaseConfig;
...
public class TokenAuthenticationFilter extends OncePerRequestFilter {
    ...
    private void setAuthErrorDetails(HttpServletResponse response) throws IOException {
        ...
        ProblemDetail problemDetail = ProblemDetail.forStatusAndDetail(status, "Authentication failure: Token missing, invalid or expired");
